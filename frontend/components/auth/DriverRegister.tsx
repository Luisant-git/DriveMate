...
const DriverRegister: React.FC = () => {
  ...
  return (
    <form onSubmit={handleRegister} className="animate-fade-in flex-grow flex flex-col overflow-y-auto w-full max-w-lg mx-auto">
      <button type="button" onClick={() => navigate('/driver/login')} className="mb-4 text-gray-400 hover:text-black flex items-center gap-1 text-sm font-bold">
        ← Back to Login
      </button>
      ...
      <div className="space-y-3 flex-grow overflow-y-auto pr-2">
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 mb-1 uppercase">Alternate Phone 1</label>
          <input 
            type="tel"
            className="w-full bg-gray-100 border-none rounded-lg p-2 text-sm font-medium focus:ring-2 focus:ring-black"
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 mb-1 uppercase">Alternate Phone 2</label>
          <input 
            type="tel"
            className="w-full bg-gray-100 border-none rounded-lg p-2 text-sm font-medium focus:ring-2 focus:ring-black"
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 mb-1 uppercase">Alternate Phone 3</label>
          <input 
            type="tel"
            className="w-full bg-gray-100 border-none rounded-lg p-2 text-sm font-medium focus:ring-2 focus:ring-black"
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 mb-1 uppercase">Alternate Phone 4</label>
          <input 
            type="tel"
            className="w-full bg-gray-100 border-none rounded-lg p-2 text-sm font-medium focus:ring-2 focus:ring-black"
        ...
        <div>
          <label className="block text-xs font-bold text-gray-500 mb-1 uppercase">UPI ID (GPay/PhonePe)</label>
          <input 
            type="text"
            className="w-full bg-gray-100 border-none rounded-lg p-2 text-sm font-medium focus:ring-2 focus:ring-black"
